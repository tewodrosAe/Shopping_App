...
const AdminDetails = ({admin, handleDelete ,canDelete ,currentId}) => {
  return (
        ...
        <td>
          {
            ...
            <button className='w-fit p-0.5 flex items-center ml-auto mr-9 gap-1 border px-3 bg-error/40 text-red-700 rounded-sm brightness-50 opacity-30'><AiOutlineDelete/> Delete</button >
          }
        </td>
    </tr>
  )
